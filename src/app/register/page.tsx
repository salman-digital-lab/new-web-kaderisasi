...
export default function Register() {
	return (
		<main className="w-full lg:flex min-h-[100vh]">
			<section className="bg-primary lg:bg-white flex justify-center items-center lg:w-[55vw] p-4">
				...
				<div className="flex flex-col gap-4">
					<div className="flex items-end justify-between gap-4">
						<h1 className="font-bold text-lg md:text-4xl lg:text-2xl">
							<span className="block mb-[-5px] md:mb-0">Daftarkan Diri Anda </span>
							<span className="block">Menjadi Bagian Dari Kami</span>
						</h1>
          ...
          <p className="text-center mt-4 lg:mt-6 pr-1 md:text-xl lg:text-base">Sudah Punya Akun? <Link href={'/login'} className="font-bold hover:text-primary-500 active:bg-primary-400">Masuk</Link></p>
				</div>
			</section>
		</main>
	);
