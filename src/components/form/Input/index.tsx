    ...
    <>
      ...
      {type === 'password'
        ? <div className="relative">
            ...
            <button onClick={passwordViewToggle} className={`absolute right-4 bottom-5 cursor-pointer hover:opacity-50 active:opacity-60 ${passwordVisible ? 'opacity-80' : 'opacity-30'}`}>
