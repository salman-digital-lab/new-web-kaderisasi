...
const Navbar = ({ isNavbarScrolling }: { isNavbarScrolling: boolean }) => {
        ...
        <div className="flex justify-between items-center">
          ...
          <div className="hidden md:flex justify-center">
            <Link href="/" legacyBehavior>
              <a>
                <div className={`p-4 border-b-4 border-transparent transition-all duration-500 hover:font-bold ${pathname === "/" ? "font-bold" : ""}`}>
            ...
            <Link href="/activities" passHref legacyBehavior>
              <a>
                <div className={`p-4 border-b-4 border-transparent transition-all duration-500 hover:font-bold ${pathname === "/activities" ? "font-bold" : ""}`}>
            ...
            <Link href="/student-care" passHref legacyBehavior>
              <a>
                <div className={`p-4 border-b-4 border-transparent transition-all duration-500 hover:font-bold ${pathname === "/student-care" ? "font-bold" : ""}`}>
            ...
            <Link href="/about-us" passHref legacyBehavior>
              <a>
                <div className={`p-4 border-b-4 border-transparent transition-all duration-500 hover:font-bold ${pathname === "/about-us" ? "font-bold" : ""}`}>
                  ...
                  {showChild &&
                    productChild.map((item) => (
                      <Link href={item.url} passHref legacyBehavior>
                        <a>
                          <div className={`p-4 border-b-4 border-transparent transition-all duration-500 hover:font-bold md:hidden bg-white ${pathname === "" ? "font-bold" : ""}`}>
                            <p>{item.name}</p>
                          </div>
                        </a>
                      </Link>
            ...
            {!user ? (
              <>
                <Link href="/login" passHref legacyBehavior>
                  <a>
                    <div className={`px-9 py-2 border-b-4 border-solid border-[3px] border-white rounded-lg bg-bmka-accent-orange transition-all duration-500 hover:bg-bmka-accent-orange-darken`}>
              ...
              <Link href="/profile" passHref legacyBehavior>
                <a>
                  <div className={`p-4 border-b-4 border-transparent transition-all duration-500 hover:font-bold ${pathname === "/profile" ? "font-bold" : ""}`}>
          ...
          <div className="flex gap-4 items-center md:hidden">
            <Link href="/login" passHref legacyBehavior>
              <a>
                <div className={`px-6 py-2 border-b-4 border-solid border-[3px] border-white rounded-lg bg-bmka-accent-orange transition-all duration-500 hover:bg-bmka-accent-orange`}>
                  <p className="text-white text-xs">Masuk</p>
                </div>
              </a>
            </Link>
            <div role="button" onClick={() => setIsActive(true)} className="p-2">
          ...
          <div className={`fixed bg-bmka-primary-blue z-10 top-0 h-full w-full p-10 md:hidden transition-all duration-500 ${isActive ? "right-0" : "-right-full"}`}>
            <div className="flex justify-end">
              <div role="button" onClick={() => setIsActive(false)} className="w-min p-2">
